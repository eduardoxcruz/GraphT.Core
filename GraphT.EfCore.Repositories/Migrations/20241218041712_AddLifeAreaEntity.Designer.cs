...
namespace GraphT.EfCore.Repositories.Migrations
{
    ...
    [Migration("20241218041712_AddLifeAreaEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphT.Model.Aggregates.LifeAreaAggregate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LifeAreaAggregateTaskAggregate", b =>
                {
                    b.Property<Guid>("LifeAreasId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TasksId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("LifeAreasId", "TasksId");

                    b.HasIndex("TasksId");

                    b.ToTable("LifeAreaAggregateTaskAggregate");
                });
            ...
            modelBuilder.Entity("LifeAreaAggregateTaskAggregate", b =>
                {
                    b.HasOne("GraphT.Model.Aggregates.LifeAreaAggregate", null)
                        .WithMany()
